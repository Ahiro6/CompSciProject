...
class Swarm:
    ...
    def __init__(self, n, size, speed_x, speed_y, health, points, grid_mode=True, type_unit=Basic, bump=0):
    ...
    def generate_units(self, speed_x, speed_y, n=None, room_size=3):
        ...
        while len(self.units) < n:
            ...
            while space > room_size * (2 * self.size * WIDTH + self.gap) and not len(self.units) == n:
    ...
    #moves units when being moved as a grid
    def move_units(self):
